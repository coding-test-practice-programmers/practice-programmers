function solution(answers) {
  ...
  mathHateMan1Score = answers.filter(
    (answer, index) =>
      answer === mathHateMan1Pick[index % mathHateMan1Pick.length]
  ).length;

  mathHateMan2Score = answers.filter(
    (answer, index) =>
      answer === mathHateMan2Pick[index % mathHateMan2Pick.length]
  ).length;

  mathHateMan3Score = answers.filter(
    (answer, index) =>
      answer === mathHateMan3Pick[index % mathHateMan3Pick.length]
  ).length;
